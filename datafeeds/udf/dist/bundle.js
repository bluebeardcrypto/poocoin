!function(e, t) {
    ...
    var i = (t.prototype.getBars = function(e, t, r, s) {
        ...
        return void 0 !== e.currency_code && (i.currencyCode = e.currency_code),
    ...
    p.prototype.searchSymbols = function(i, n, a, u) {
        ...
        return this._readyPromise.then(function() {
            ...
            for (var e = 0, t = c._symbolsList; e < t.length; e++)
                !function(e) {
                    var t, r = c._symbolsInfo[e];
                    void 0 !== r && (0 < a.length && r.type !== a || n && 0 < n.length && r.exchange !== n || (t = r.name.toUpperCase().indexOf(i),
                    e = r.description.toUpperCase().indexOf(i),
                    (o || 0 <= t || 0 <= e) && (s.some(function(e) {
    ...
    p.prototype._onExchangeDataReceived = function(t, r) {
        ...
        try {
            for (var o = r.symbol.length, i = void 0 !== r.ticker; s < o; ++s) {
                ...
                e._symbolsInfo[n] = u,
                e._symbolsInfo[c] = u,
                void 0 !== l && (e._symbolsInfo[f(d, l)] = u,
    ...
    y.prototype.searchSymbols = function(t, e, r, s) {
        if (this._configuration.supports_search) {
            ...
            this._send("search", o).then(function(e) {
                return void 0 !== e.s ? (n("UdfCompatibleDatafeed: search symbols error=" + e.errmsg),
                void s([])) : void s(e)
            }).catch(function(e) {
    ...
    y.prototype.resolveSymbol = function(e, t, r, s) {
        ...
        var s = s && s.currencyCode
          , o = Date.now();
        function i(e) {
            n("Symbol resolved: " + (Date.now() - o) + "ms"),
            t(e)
        }
        if (this._configuration.supports_group_request) {
            ...
            this._send("symbols", e).then(function(e) {
    ...
    y.prototype._setupWithConfiguration = function(e) {
        ...
        !e.supports_group_request && e.supports_search || (this._symbolsStorage = new d(this._datafeedURL,e.supported_resolutions || [],this._requester)),
    ...
    var v = (P.prototype.getQuotes = function(e) {
        var s = this;
        return new Promise(function(t, r) {
    ...
    var q = (w.prototype.sendRequest = function(e, t, r) {
        void 0 !== r && (0 !== (s = Object.keys(r)).length && (t += "?"),
        t += s.map(function(e) {
        ...
        return void 0 !== this._headers && (s.headers = this._headers),
        fetch(e + "/" + t, s).then(function(e) {
            return e.text()
        }).then(function(e) {
            return JSON.parse(e)
        })
    ...
    var D, S, x, C = (r(S = k, x = D = b),
    S.prototype = null === x ? Object.create(x) : (U.prototype = x.prototype,
    new U),
    k);
    function U() {
        this.constructor = S
